...
> **Update Aug. 25 2026**: The constraint learning functionality of LAPSO is now maintained in a standalone repository [NCET: Neural Network Constraint Embedding Toolkit](https://github.com/xuwkk/ncet). See the [documentation](https://xuwkk.github.io/ncet/) for more details and install it by `pip install ncet`.
